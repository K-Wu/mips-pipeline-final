...
#set_property PACKAGE_PIN V13 [get_ports {watchdog[0]}]
#set_property PACKAGE_PIN V3 [get_ports {watchdog[1]}]
#set_property PACKAGE_PIN W3 [get_ports {watchdog[2]}]
#set_property PACKAGE_PIN U3 [get_ports {watchdog[3]}]
#set_property PACKAGE_PIN P3 [get_ports {watchdog[4]}]
#set_property PACKAGE_PIN N3 [get_ports {watchdog[5]}]
#set_property PACKAGE_PIN P1 [get_ports {watchdog[6]}]
#set_property PACKAGE_PIN L1 [get_ports {watchdog[7]}]
...
#set_property IOSTANDARD LVCMOS33 [get_ports {watchdog[7]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {watchdog[6]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {watchdog[5]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {watchdog[4]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {watchdog[3]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {watchdog[2]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {watchdog[1]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {watchdog[0]}]
